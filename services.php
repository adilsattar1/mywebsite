...
<html lang="en"> 
<head>
	<title>Adil Sahito | Services</title>
	...
	<div class="main-wrapper">
		<section class="cta-section theme-bg-light py-5">
			<div class="container text-center single-col-max-width">
				...
				<div class="intro">
					<p>I have 10+ years of development experience building software for the web and mobile devices. You can take a look at my <a href="portfolio" target="_blank">project portfolio</a> and <a href="resume" target="_blank">online resume</a> to find out more about my skills and experiences.</p>
